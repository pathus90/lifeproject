...
@RemoteServiceRelativePath("PotUserGroupService")
public interface PotUserGroupService extends IPotService<TransitLPUserGroup, LPUserGroup> {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static PotUserGroupServiceAsync instance;
		public static PotUserGroupServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(PotUserGroupService.class);
			}
			return instance;
		}
	}
