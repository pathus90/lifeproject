 ...
 */
public class ActorHolderPlace extends Place {
	...
	public ActorHolderPlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<ActorHolderPlace> {

		@Override
		public String getToken(ActorHolderPlace place) {
			return place.getName();
		}

		@Override
		public ActorHolderPlace getPlace(String token) {
			return new ActorHolderPlace(token);
		}
