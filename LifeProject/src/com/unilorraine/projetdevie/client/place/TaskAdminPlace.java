 ...
 */
public class TaskAdminPlace extends Place {
	...
	public TaskAdminPlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<TaskAdminPlace> {

		@Override
		public String getToken(TaskAdminPlace place) {
			return place.getName();
		}

		@Override
		public TaskAdminPlace getPlace(String token) {
			return new TaskAdminPlace(token);
		}
